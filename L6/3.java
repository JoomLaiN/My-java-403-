...
public class Main
{
	public static void main(String[] args) {
    	...
    	month_int_rate = annual_int_rate12100;
    	month_pay = amount  month_int_rate  (1 - 1  Math.pow(1 + month_int_rate, years  12));
    	total_pay = month_pay  years  12;
    	System.out.println(Monthly payment  + (int)(month_pay100)100.0 +  Rub);
    	System.out.println(Total payment  + (int)(total_pay100)100.0 +  Rub);
	}
}